...
namespace WarehouseSystemAnalyst.Mediator.Commands.Handlers.UpdateCommands
{
    ...
    /// <summary>
    /// Generic mediator handler handles inventory transaction  updated given source and destination
    /// </summary>
    ...
    public class UpdateInventoryCommandHandler<TSource, TSourceDto, TDestination, TDestinationDto, TCommand> : ITransactionHandlerWrapper<TCommand, TSource, TSourceDto, TDestination, TDestinationDto>
    ...
    where TCommand : class, ITransactionWrapper<TSource, TSourceDto, TDestination, TDestinationDto>, new()
    {
        ...
        public UpdateInventoryCommandHandler(IUnitOfWorkRepository<WarehouseDbContext> unitOfWork)
        {
