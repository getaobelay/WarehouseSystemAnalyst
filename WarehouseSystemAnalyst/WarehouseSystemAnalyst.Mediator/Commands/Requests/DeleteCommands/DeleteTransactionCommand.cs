...
namespace WarehouseSystemAnalyst.Mediator.Commands.Requests.CreateCommands
{
    ...
    public class DeleteTransactionCommand<TSource, TSourceDto , TDestination, TDestinationDto> : ITransactionWrapper<TSource, TSourceDto, TDestination, TDestinationDto>
