...
{
    /// <summary>
    /// this command creates inventory with source and destination entities
    /// </summary>
    ...
    public class CreateTransactionCommand<TSource, TSourceDto, TDestination, TDestinationDto> :
        ITransactionWrapper<TSource, TSourceDto, TDestination, TDestinationDto>
